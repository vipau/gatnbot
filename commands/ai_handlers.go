...
func registerAIHandlers(b *tb.Bot, configmap settings.Settings) {
	b.Handle("/deepseekr1", func(c tb.Context) error {
		...
		var client = gpt3.NewClient(configmap.DeepseekApiKey, gpt3.WithDefaultEngine(ModelDeepSeekReasoner), gpt3.WithBaseURL(DeepSeekBaseURL), gpt3.WithTimeout(ReasonerTimeout))
		return callOAIAPI(client, false, c, configmap, b, prompt, ModelDeepSeekReasoner)
	})
	...
	b.Handle("/deepseek", func(c tb.Context) error {
		var client = gpt3.NewClient(configmap.DeepseekApiKey, gpt3.WithDefaultEngine(ModelDeepSeekChat), gpt3.WithBaseURL(DeepSeekBaseURL), gpt3.WithTimeout(DefaultAITimeout))
		return callOAIAPI(client, false, c, configmap, b, "", ModelDeepSeekChat)
	})

	b.Handle("/cgpt4", func(c tb.Context) error {
		var client = gpt3.NewClient(configmap.OpenaiApiKey, gpt3.WithDefaultEngine(ModelChatGPT4oLatest), gpt3.WithBaseURL(OpenAIBaseURL), gpt3.WithTimeout(DefaultAITimeout))
		return callOAIAPI(client, false, c, configmap, b, "", ModelChatGPT4oLatest)
	})

	b.Handle("/gpt4005", func(c tb.Context) error {
		var client = gpt3.NewClient(configmap.OpenaiApiKey, gpt3.WithDefaultEngine(ModelGPT4o20240513), gpt3.WithBaseURL(OpenAIBaseURL), gpt3.WithTimeout(DefaultAITimeout))
		return callOAIAPI(client, false, c, configmap, b, "", ModelGPT4o20240513)
	})

	b.Handle("/gpt41", func(c tb.Context) error {
		var client = gpt3.NewClient(configmap.OpenaiApiKey, gpt3.WithDefaultEngine(ModelGPT41), gpt3.WithBaseURL(OpenAIBaseURL), gpt3.WithTimeout(DefaultAITimeout))
		return callOAIAPI(client, false, c, configmap, b, "", ModelGPT41)
	})
	...
	b.Handle("/s", func(c tb.Context) error {
		...
		var client = gpt3.NewClient(configmap.OpenaiApiKey, gpt3.WithDefaultEngine(ModelChatGPT4oLatest), gpt3.WithBaseURL(OpenAIBaseURL), gpt3.WithTimeout(DefaultAITimeout))
		return callOAIAPI(client, false, c, configmap, b, prompt, ModelChatGPT4oLatest)
	})

	b.Handle("/gemini", func(c tb.Context) error {
		return callGemini(ModelGemini10Pro, true, c, configmap, b)
	})

	b.Handle("/geminicode", func(c tb.Context) error {
		return callGemini(ModelGemini10Pro, false, c, configmap, b)
	})

	b.Handle("/gemini15", func(c tb.Context) error {
		return callGemini(ModelGemini15Pro, true, c, configmap, b)
	})
	...
	b.Handle("/claude", func(c tb.Context) error {
		return callClaude(ModelClaude35Sonnet, true, c, configmap, b)
	})

	b.Handle("/claudecode", func(c tb.Context) error {
		return callClaude(ModelClaude35Sonnet, false, c, configmap, b)
	})
}
